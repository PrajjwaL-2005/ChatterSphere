...
export const getAllPosts = TryCatch(async(req,res)=>{
    ...
    .sort({createdAt:-1}).populate("owner" , "-password") ;
...
// Exporting the commentonPost function wrapped with TryCatch for error handling
...
export const deleteComment = TryCatch(async(req,res)=>{
    ...
    if(!req.body.commentId) return res.status(404).json({
